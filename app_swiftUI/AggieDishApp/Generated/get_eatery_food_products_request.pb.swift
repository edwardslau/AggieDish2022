...
// Source: protos/get_eatery_food_products_request.proto
//
...
struct Model_GetEateryFoodProductsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The identifier of the eatery for which to retrieve the food products.
...
extension Model_GetEateryFoodProductsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetEateryFoodProductsRequest"
  ...
  static func ==(lhs: Model_GetEateryFoodProductsRequest, rhs: Model_GetEateryFoodProductsRequest) -> Bool {
