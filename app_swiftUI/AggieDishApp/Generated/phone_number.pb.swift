...
struct Google_Type_PhoneNumber {
  ...
  var kind: Google_Type_PhoneNumber.OneOf_Kind? = nil
  ...
  var shortCode: Google_Type_PhoneNumber.ShortCode {
    get {
  ...
  #if !swift(>=4.1)
    static func ==(lhs: Google_Type_PhoneNumber.OneOf_Kind, rhs: Google_Type_PhoneNumber.OneOf_Kind) -> Bool {
...
extension Google_Type_PhoneNumber: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Google_Type_PhoneNumber, rhs: Google_Type_PhoneNumber) -> Bool {
...
extension Google_Type_PhoneNumber.ShortCode: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Google_Type_PhoneNumber.protoMessageName + ".ShortCode"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Google_Type_PhoneNumber.ShortCode, rhs: Google_Type_PhoneNumber.ShortCode) -> Bool {
